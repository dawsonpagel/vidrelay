...
export default function App() {
  ...
  async function load() {
    try {
      const [userRows, subRows, msgRows, productRows, sampleRows] = await Promise.all([
        sbGet("users"),
        sbGet("submissions"),
        sbGet("messages"),
        sbGet("products"),
      ...
      <div style={styles.shellBody} className="shell-body">
        ...
        <div style={styles.mainArea}>
          {page === "overview" ? (
            ...
            <CreatorsRosterPage submissions={mySubmissions} />
          ) : role === "creator" ? (
...
function SamplesPage({ role, currentUser, brands, products, requests, onRequestSample, onUpdateStatus }) {
      ...
      <div style={styles.page}>
        <div style={styles.card}>
          ...
          <select
            ...
            value={requestBrand}
            onChange={(e) => {
              setRequestBrand(e.target.value);
              setRequestProduct("");
            }}
          >
            <option value="">Choose a brand...</option>
          ...
          {!requestBrand ? (
            ...
            <select style={styles.input} value={requestProduct} onChange={(e) => setRequestProduct(e.target.value)}>
...
function CreatorsRosterPage({ submissions }) {
  const byCreator = {};
  submissions.forEach((s) => {
