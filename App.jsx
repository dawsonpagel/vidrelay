      ...
      {isConnected && (
        <div style={styles.card}>
          <div style={styles.adsTableHeader}>
            ...
            <button style={styles.buildAdsBtn} onClick={() => setShowBuildNote(true)}>
              + Build ad
            </button>
          </div>
          {showBuildNote && (
            <div style={styles.withdrawNote}>
              Building ads directly from Vidrelay isn't set up yet — that's the next piece to build.
              For now, this table shows real ads and performance already running in your connected
              Meta Ads account.
            </div>
          )}
          ...
          approved.map((s) => (
            <div key={s.id} style={styles.rowCol}>
              <div style={styles.rowTop}>
                ...
                <span style={isConnected ? styles.statusTag : styles.pendingTag}>
                  {isConnected ? "Ready to build" : "Connect Meta first"}
                </span>
              </div>
            </div>
          ))
