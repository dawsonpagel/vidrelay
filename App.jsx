...
function mapProduct(row) {
  return { id: row.id, brandUsername: row.brand_username, productName: row.product_name };
}
        ...
        {step === "upload" ? (
          ...
          <>
            ...
            {!targetBrand ? (
              ...
              <select style={styles.input} value={productName} onChange={(e) => setProductName(e.target.value)}>
