...
export default function App() {
  ...
  if (role === "brand" && !currentUser.stripeBankPaymentMethodId) {
    return (
      <BankLinkGate
        currentUser={currentUser}
        onLogout={logOut}
        onLinked={(bankInfo) => setCurrentUser({ ...currentUser, ...bankInfo })}
      />
    );
  }
...
function BankLinkGate({ currentUser, onLogout, onLinked }) {
  ...
  return (
    <div style={styles.wrap}>
      <div style={styles.centerCol}>
        ...
        <h1 style={{ ...styles.h1, fontSize: 28 }}>Link your bank to continue</h1>
        <p style={styles.sub}>
          Vidrelay charges a small 2.5% platform fee on sales your creators drive, billed weekly to your
          bank account. This is required once before you can start using Vidrelay.
        </p>
        ...
        <button style={styles.linkBtnLight} onClick={onLogout}>
          log out
        </button>
      </div>
    </div>
...
function BrandInfoTab({ currentUser, onUploadLogo, onUpdateBrandInfo, onUpdateContentFocus }) {
