  ...
  return (
    <div style={styles.page}>
      ...
      <div style={styles.card}>
        ...
        />
        <label style={styles.label}>TikTok video link (optional)</label>
        <input
          style={styles.input}
        ...
        />
        <label style={styles.label}>Upload your video</label>
        <p style={styles.uploadHelp}>
          Upload the video from your camera roll — this is what the brand will use to build the ad.
        </p>
        <input
          type="file"
          accept="video/*"
        ...
        />
        {videoFile && <div style={styles.fileSelected}>Selected: {videoFile.name}</div>}
        <button style={styles.primaryBtn} onClick={onSubmit} disabled={uploading}>
...
function BrandSubmissionsPage({ currentUser, submissions, onSetRate, onApprove, onDisapprove, onLogSale }) {
