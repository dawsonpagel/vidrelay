...
function BrandSettingsPage({
  ...
  return (
    <div style={styles.page}>
      ...
      {tab === "info" ? (
        <BrandInfoTab currentUser={currentUser} onUploadLogo={onUploadLogo} onUpdateBrandInfo={onUpdateBrandInfo} />
      ) : (
        <ProductCatalogTab
          currentUser={currentUser}
          products={products}
...
function BrandInfoTab({ currentUser, onUploadLogo, onUpdateBrandInfo }) {
