...
export default function App() {
  ...
  async function load() {
    try {
      const [userRows, subRows, msgRows, productRows, sampleRows, payoutRows, joinRows] = await Promise.all([
        sbGet("users"),
        sbGet("submissions"),
        sbGet("messages"),
        sbGet("products"),
...
function CreatorProfilePage({ currentUser, submissions, brands, myJoins, allSampleRequests, allSubmissions, onUploadPhoto }) {
