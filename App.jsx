...
export default function App() {
  ...
  async function submitVideo() {
    ...
    if (!videoFile) {
      setError("Upload the actual video file — this is what gets used to build the ad.");
      return;
    }
    setError("");
    setUploading(true);
  ...
  return (
    <div style={styles.page}>
      ...
      <div style={styles.card}>
        ...
        />
        <label style={styles.label}>TikTok video link (for reference)</label>
        <input
          style={styles.input}
        ...
        <p style={styles.uploadHelp}>
          Upload the actual video — this is what the brand will use to build the ad.
        </p>
        <input
          type="file"
          accept="video/*"
