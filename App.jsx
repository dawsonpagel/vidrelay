      ...
      <div style={styles.card}>
        ...
        {step === "brand" ? (
          <>
            ...
            {!targetBrand ? (
              ...
              <div style={styles.productGrid}>
                {brandProducts.map((p) => (
                  <button
                    key={p.id}
                    style={productName === p.productName ? styles.productTileActive : styles.productTile}
            ...
            <button
              style={{ ...styles.primaryBtn, opacity: targetBrand && productName ? 1 : 0.5 }}
              disabled={!targetBrand || !productName}
          ...
          <>
            ...
            <button style={{ ...styles.primaryBtn, opacity: videoFile ? 1 : 0.5 }} onClick={submitAndReset} disabled={uploading || !videoFile}>
