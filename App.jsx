...
function ChatPage({ currentUser, partners, messages, onSend }) {
              ...
              return (
                ...
                >
                  ...
                  <div style={{ minWidth: 0, flex: 1 }}>
                    <div style={styles.chatListName}>{p}</div>
                    <div style={styles.chatListPreview}>
...
const styles = {
  ...
  chatList: { width: 220, flexShrink: 0, borderRight: `1px solid ${COLORS.line}`, overflowY: "auto", display: "flex", flexDirection: "column" },
